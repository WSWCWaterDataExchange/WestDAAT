    ...
    <div className='d-flex flex-row'>
        {waterRightDetails && <>
            <div className='d-flex p-2 flex-column'>
                ...
                <span className='property-value'>{waterRightDetails.allocationLegalStatusCv}</span>
            ...
            <div className='d-flex p-2 flex-column'>
                ...
                <span className='property-value'>{waterRightDetails.aggregationIntervalUnitCv}</span>
                                    
                <span className='property-name'>Statistic</span>
                <span className='property-value'>{waterRightDetails.aggregationStatisticCv}</span>
                ...
                <span className='property-value'>{waterRightDetails.reportYearTypeCv}</span>
