...
export function useWaterRightsSearchCriteriaWithoutContext({filters, nldiIds}: SearchCriteriaProps) {
  ...
  }, [beneficialUseNames, polylines, includeExempt, minFlow, maxFlow, minVolume, maxVolume, podPou, minPriorityDate, maxPriorityDate, ownerClassifications, waterSourceTypes, riverBasinNames, allocationOwner, states, nldiIds]) 
