...
const UploadModal = () => {
  ...
  const processShapefileZip = async (fileContent: ArrayBuffer) => {
    try {
      ...
      if (featureCollection && featureCollection.features.length > 0 && validateGeoJSONPolygon(featureCollection)) {
        ...
        <>
          <Form>
            <Form.Group controlId="formFile">
              ...
              <Form.Control type="file" accept=".json, .geojson, .zip, .shp" onChange={handleFileUpload} />
            </Form.Group>
          </Form>
