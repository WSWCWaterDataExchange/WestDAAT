...
export function FlowRange() {
  ...
  return <div className="mb-3">
    ...
    <NumericRange initialMin={minValue} initialMax={maxValue} onChange={handleFlowChange} units="" precision={2} minControlProps={minControlProps} maxControlProps={maxControlProps} />
  </div>;
}
