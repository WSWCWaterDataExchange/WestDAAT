      ...
      <Container fluid className="ms-2 me-2">
        <div className="px-5">
          <Nav>
            ...
            <Nav.Link className="p-0 s-1" target="_blank" rel="noopener noreferrer" href="https://github.com/WSWCWaterDataExchange/WestDAAT/"><img className="github-logo" src={github_mark_white}/></Nav.Link>
          </Nav>
        </div>
