...
interface BeneficialUseSelectProps {
  options: BeneficialUseChangeOption[] | undefined;
  selectedOptions: BeneficialUseChangeOption[] | undefined;
...
function BeneficialUseSelect(props: BeneficialUseSelectProps) {
  ...
  // const layerOptionStyles: StylesConfig<BeneficialUseListItem, true> = {
