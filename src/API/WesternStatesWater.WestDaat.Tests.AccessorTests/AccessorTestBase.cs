...
namespace WesternStatesWater.WestDaat.Tests.AccessorTests
{
    ...
    public abstract class AccessorTestBase : IDisposable
    {
        ...
        {
            { $"{ConfigurationRootNames.Database}:{nameof(DatabaseConfiguration.ConnectionString)}", "Server=.;Initial Catalog=WaDE2Test; User=sa; Password=DevP@ssw0rd!; TrustServerCertificate=true;" },
