...
public class EstimateConsumptiveUseApplicantRequestValidator : AbstractValidator<EstimateConsumptiveUseApplicantRequest>
{
    public EstimateConsumptiveUseApplicantRequestValidator()
    {
