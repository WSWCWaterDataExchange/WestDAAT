...
#pragma warning disable CA1502
        ...
        private void AddApplicationMappings()
        {
            CreateMap<EFWD.WaterConservationApplication, ApplicationListItemDetails>()
                ...
                .ForMember(dest => dest.TotalAverageYearlyConsumptionEtAcreFeet, opt => opt.MapFrom(src => src.Estimate.SumAverageYearlyTotalEtInAcreFeet));
            ...
            CreateMap<ApplicationEstimateStoreRequest, EFWD.WaterConservationApplicationEstimate>()
                ...
                .ForMember(dest => dest.SumAverageYearlyTotalEtInAcreFeet, opt => opt.MapFrom(src => src.SumAverageYearlyTotalEtInAcreFeet))
                .ForMember(dest => dest.SumAverageYearlyEffectivePrecipitationInAcreFeet, opt => opt.Ignore())
                .ForMember(dest => dest.SumAverageYearlyNetEtInAcreFeet, opt => opt.Ignore());
