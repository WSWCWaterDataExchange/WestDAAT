    ...
    internal class ApiProfile : Profile
    {
        public ApiProfile()
        {
            ...
            CreateMap<EF.AllocationAmountsFact, WaterRightDetails>()
                ...
                .ForMember(dest => dest.MethodType, opt => opt.MapFrom(source => source.Method.MethodTypeCvNavigation.Name))
                .ForMember(dest => dest.MethodLink, opt => opt.MapFrom(source => source.Method.MethodTypeCvNavigation.SourceVocabularyUri))
                .ForMember(dest => dest.MethodDescription, opt => opt.MapFrom(source => source.Method.MethodTypeCvNavigation.Definition))
