...
namespace WesternStatesWater.WestDaat.Common.Configuration
{
    public static class ConfigurationHelper
    {
        public static Dictionary<string, string> DefaultConfiguration => new Dictionary<string, string>
        {
            ...
            { $"{ConfigurationRootNames.OpenEt}:{nameof(OpenEtConfiguration.MaximumPermissibleRequestsPerMinute)}", "20" },
            { $"{ConfigurationRootNames.OpenEt}:{nameof(OpenEtConfiguration.MaximumQueueableRequestsPerMinute)}", "20" },
